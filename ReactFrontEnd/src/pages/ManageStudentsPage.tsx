...
export default function ManageStudentsPage() {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    const res = await fetch(`${API_URL}/api/user/role/student`);
  ...
  return (
      <div className="max-w-5xl mx-auto py-10 px-4 min-h-[80vh]">
        <h1 className="text-3xl font-bold text-emerald-700 mb-2 text-center">Manage Students</h1>
        <p className="text-gray-500 text-center mb-8">Manage all students in the system</p>
        ...
        {editing && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
            <div className="bg-white rounded-xl shadow-2xl border border-emerald-200 p-8 w-full max-w-md animate-fade-in-up relative">
              ...
              <h3 className="text-xl font-bold text-emerald-700 mb-4">Edit Student</h3>
              <div className="mb-4">
