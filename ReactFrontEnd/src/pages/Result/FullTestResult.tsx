...
export default function FullTestResult() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    apiClient.get<any>(`/test-results/full-tests/${testAnswerId}`)
      .then((data) => {
        setResults(data || {});
        setLoading(false);
      })
      .catch((e: any) => {
        setError(e.message || "Not found full test result");
        setLoading(false);
      });
  }, [testAnswerId]);
              ...
              <Card className="mx-auto bg-gradient-to-r from-green-200 to-green-100 text-gray-600 border-0 shadow-2xl">
                <CardContent className="p-8 text-center space-y-4">
                  ...
                  <div className="pt-2">
                    ...
                    >
                      🔍 View Full Test Detailed Explanation
                    </Button>
                  </div>
                </CardContent>
              </Card>
